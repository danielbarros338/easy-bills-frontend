<template>
  <CardBaseComponent background="bg-grey-2" :head="true">
    <template #head>
      <h4 class="full-width q-my-sm">Novo Mês</h4>
    </template>

    <template #body>
      <div class="col-12 earnings-container text-dark">
        <h5 class="full-width q-my-sm">Ganhos</h5>
